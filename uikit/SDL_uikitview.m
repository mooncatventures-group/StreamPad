...
- (id)initWithFrame:(CGRect)frame {
	...
	hudView = [[HUDView alloc] initWithFrame:CGRectMake(-60,170,260,80) andText:nil];
	hudView.transform  = CGAffineTransformMakeRotation(DEGREES_TO_RADIANS(90));
